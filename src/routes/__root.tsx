...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Sitio oficial de Leandro Pagura: bajista, sesionista y educador. Groove, sesiones, shows y plataforma de cursos." },
      { name: "author", content: "Leandro Pagura" },
      { property: "og:title", content: "Leandro Pagura — Bajista, sesionista y educador" },
      { property: "og:description", content: "Groove y solidez en la escena musical nacional e internacional. Shows, proyectos y plataforma de cursos." },
