      ...
      <section id="bio" className="py-24">
        <div className="container-x grid md:grid-cols-5 gap-12 items-center">
          ...
          <div className="md:col-span-3">
            ...
            <p className="text-2xl md:text-4xl text-foreground mb-6 font-display leading-tight">
              Conocé la trayectoria, los proyectos y el recorrido musical de Leandro Pagura.
            </p>
